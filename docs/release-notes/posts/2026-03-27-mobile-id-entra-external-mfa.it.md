...
video:
  title: "Mobile ID e Microsoft Entra ID: MFA rafforzata con External Authentication"
  description: "Breve video esplicativo che mostra come Mobile ID si integra con Microsoft Entra External MFA."
...
<VideoEmbed src="/release-notes/media/entra-external-mfa-explainer.mp4" poster="/release-notes/img/entra-eam-thumb.png" link-text="Apri MP4">
